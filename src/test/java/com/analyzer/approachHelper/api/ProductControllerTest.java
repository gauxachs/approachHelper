...
public class ProductControllerTest {
    ...
    public void setUp() {
        ...
        when(productService.createProduct(DESCRIPTION)).thenReturn(product);
    ...
    public void testCreateProduct() throws Exception {
        var createProductRequest = new CreateProductRequest(DESCRIPTION);
        var jsonObject = objectMapper.writeValueAsString(createProductRequest);
